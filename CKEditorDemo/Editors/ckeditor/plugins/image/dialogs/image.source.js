...
{ 
  ...
  { 
    ...
    return 
    { 
      title: c == 'image'?b.lang.image.title: b.lang.image.titleButton, minWidth: 420, minHeight: CKEDITOR.env.ie && CKEDITOR.env.quirks?360: 310, onShow: function() 
      { 
        var I = this; 
...
D.removeAttribute('src'); 
            ...
            , 
            { 
              type: 'button', id: 'browse', style: 'display: inline - block; 
              margin - top: 10px; 
        ...
        { 
          ...
          { 
            ...
            { 
              ...
              , 
              { 
                type: 'html', style: 'margin - top: 30px; 
                width: 40px; 
                height: 40px; 
                ', onLoad: function() 
                { 
                ...
                { 
                  ...
                  { 
                    ...
                    { 
                      ...
                      switch(F) 
                      { 
                        case 'left': case 'right': D.removeAttribute('align'); 
...
if(! E)E = D.getAttribute('href'); 
        ...
        , 
        { 
          id: 'cmbTarget', type: 'select', label: b.lang.common.target, 'default': '', items: [[b.lang.common.notSet, ''], [b.lang.common.targetNew, '_blank'], [b.lang.common.targetTop, '_top'], [b.lang.common.targetSelf, '_self'], [b.lang.common.targetParent, '_parent']], setup: function(C, D) 
          { 
      ...
      { 
        ...
        { 
          ...
          , 
          { 
            id: 'cmbLangDir', type: 'select', style: 'width: 100px; 
            ', label: b.lang.common.langDir, 'default': '', items: [[b.lang.common.notSet, ''], [b.lang.common.langDirLtr, 'ltr'], [b.lang.common.langDirRtl, 'rtl']], setup: function(C, D) 
            { 
